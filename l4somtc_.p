/* l4somtc_.p  [l4somtc.p]  [sosomtc.p] - SALES ORDER MAINTENANCE TRAILER SECTION  */
...
/* Revision: SE13     Last modi: 2015.01.02     by:   *Y702* Arunas K. [ sosomtc2.p -> l4somtc2.p  ] */
/* Revision: SE13     Last modi: 2015.02.03     by:   *Y703* Arunas K. [ + ", input p__sft01, input p__csb" ] */
/* Revision: SE13     Last modi: 2015.05.11     by:   *Y704* Arunas K. [ + ", input p__sft02" ] */
/* Revision: SE13     Last modi: 2015.06.08     by:   *Y705* Arunas K. [ p__qxt,p__h15 ] */
...
/*Y705*/  define input parameter         p__qxt     as logical.
/*Y705*/  define input parameter         p__h15     as logical.

/*Y703*/  define variable ar_p_nm_vers  as character  initial "l4somtc_.p Y705" no-undo.
...
undo_mtc3 = true.
/*Y703  {gprun.i ""sosomtc3.p""}  */
/*Y703*/  {gprun.i ""l4somtc3.p"" "(input p__sft01, /*Y704*/ input p__sft01, input p__csb  )"}

if not undo_mtc3 then do:
   if undo_mainblk then leave.
   undo_mtc2 = true.

/*Y702   {gprun.i ""sosomtc2.p""}  */

/*Y703*/ if p__csb then do:
/*Y702*/   {gprun.i ""l4somtc2.p"" /*Y705*/ "(input p__qxt, input p__h15)"}
/*Y703*/ end.
/*Y703*/ else do:
/*Y703*/   {gprun.i ""sosomtc2.p""}
/*Y703*/ end.
