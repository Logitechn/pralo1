/* l4somt1_.p [l4somt1.p] [sosomt1.p] - SALES ORDER MAINTENANCE                            */
...
/* Revision: SE13     Last modi: 2015.07.01     by:   *Y703* Arunas K. [ qxotrign.i -> lysomddp.p ] */
...
/*Y703*/  define variable ar_p_nm_vers  as character  initial "l4somt1_.p Y703" no-undo.
...
/*Y702*/  {gprun.i ""l4somtc.p"" "(input this-is-rma)"}
...
.            &TRIGGER-TYPE = 'WRITE'}.
*/
/*Y703*/ {gprun.i ""lysomddp.p"" "(input rowid(so_mstr))"}
