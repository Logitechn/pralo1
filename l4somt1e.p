/* l4somt1e.p [l4somt1_.p] [l4somt1.p] [sosomt1.p] - SALES ORDER MAINTENANCE   */
...
/* Revision: SE13     Last modi: 2014.12.09     by:   *Y701* Arunas K. [ kaina - á sod__qadd03 ] */
/* Revision: SE13     Last modi: 2015.01.02     by:   *Y702* Arunas K. [ so__qadd03=1:  Siøsti á CSB  ] */
/* Revision: SE13     Last modi: 2015.02.03     by:   *Y703* Arunas K. [ + ", input p__sft01, input p__csb" ] */
/* Revision: SE13     Last modi: 2015.02.13     by:   *Y704* Arunas K. [ + ", input p__csb2, input l_csb3" ] */
/* Revision: SE13     Last modi: 2015.02.17     by:   *Y705* Arunas K. [ + ", input p__i03" ] */
/* Revision: SE13     Last modi: 2015.04.07     by:   *Y706* Arunas K.  [ + ", input p__csb4" ]  */
/* Revision: SE13     Last modi: 2015.05.11     by:   *Y708* Arunas K. [ + ", input p__sft02" ] */
/* Revision: SE13     Last modi: 2015.06.08     by:   *Y709* Arunas K. [ p__qxt,p__h15 ] */
/* Revision: SE13     Last modi: 2015.07.01     by:   *Y710* Arunas K. [ qxotrign.i -> lysomddp.p ] */

/* Revision: SE13     Last modi: 2015.08.19     by:   *Y712* Arunas K. [ + (p__nconf), p__part1_9 ] */
/* Revision: SE13     Last modi: 2015.08.19     by:   *Y713* Arunas K. [ so_cr_init:FORMAT IN FRAME d = "x(8)"] */
...
/*Y708*/  define input parameter         p__sft02     as logical.
/*Y703*/  define input parameter         p__csb     as logical.
/*Y704*/  define input parameter         p__csb2     as logical.   /* "Uþsakymas perduotas á CSB. Atðaukti" */
/*Y707*/  define input parameter         p__csb4     as logical.
/*Y709*/  define input parameter         p__qxt     as logical.
/*Y709*/  define input parameter         p__h15     as logical.
/*Y712*/  define input parameter         p__nconf     as logical.
/*Y712*/  define input parameter         p__part1_9   as logical.

/*Y703*/  define variable ar_p_nm_vers  as character  initial "l4somt1e.p Y713" no-undo.
/*Y704*/  define variable l_csb3       as logical initial yes no-undo. /* "Uþsakymas perduotas á CSB. Koreguoti negalima..." */
/*Y705*/  define variable n_i03        as integer initial 0 no-undo.
/*Y708*/  define variable l__sft01b    as logical initial yes no-undo. /* for each so_mstr where   so_nbr <> ip-nbr */
...
/*Y713*/   ASSIGN so_cr_init:FORMAT IN FRAME d = "x(8)"
             so_cr_init:LABEL  IN FRAME d = "Marðrutas".
...
/*Y708*/  find code_mstr where code_domain = global_domain  and code_fldname = "##CREDIT-CONTROL"
...
/*Y703         {gprun.i ""sosomta1.p""  */
/*Y703*/ {gprun.i ""l4somta1.p""
            "(input this-is-rma,
/*Y704*/      input p__sft01, input p__csb, input p__csb2, input l_csb3,
/*Y705*/      input n_i03,
/*Y706*/      input p__csb4,
              output return_int,
              output rma-recno)"}
         ...
         do on endkey undo ,retry:
            ...
            {gpcontxt.i
               &STACKFRAG = 'l4som__0,l4som__1,l4som__2,l4som__3,l4somt1e,sosomta,sosomt1,fsrmamt'
               &FRAME = 'c' &CONTEXT = 'ISS'}
/*Y703               &STACKFRAG = 'sosomta,sosomt1,fsrmamt'  */

/*Y701            {gprun.i ""sosomta.p""     */
/*Y703 /*Y701*/     {gprun.i ""l4somta.p""   */
/*Y703*/     {gprun.i ""l4somta_.p""
               "(input this-is-rma,
                 input rma-recno,
                 input yes
/*Y703*/         , input p__sft01, /*Y708*/ input l__sft01b, input p__csb, /*Y712*/ input p__part1_9)"}

            /* Clear context for QXtend */
            {gpcontxt.i
               &STACKFRAG = 'l4som__0,l4som__1,l4som__2,l4som__3,l4som__4,l4somt1e,sosomta,sosomt1,fsrmamt'
               &FRAME = 'c'}
/*Y703               &STACKFRAG = 'sosomta,sosomt1,fsrmamt'  */
...
/*Y702         {gprun.i ""sosomtc.p"" "(input this-is-rma)"} */
/*Y703  /*Y702*/  {gprun.i ""l4somtc.p"" "(input this-is-rma)"}  */
/*Y703*/  {gprun.i ""l4somtc_.p"" "(input this-is-rma ,input p__sft01, /*Y708*/ input p__sft02, input p__csb
                        /*Y709*/, input p__qxt, input p__h15 )"}
...
.            &TRIGGER-TYPE = 'WRITE'}.
*/
/*Y710*/ {gprun.i ""lysomddp.p"" "(input rowid(so_mstr))"}
